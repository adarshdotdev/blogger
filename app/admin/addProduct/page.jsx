    ...
    return (
        <>
            <form onSubmit={onsubmitHandler} className='pt-5 px-5 sm:pt-12 sm:pl-16'>
                ...
                <label htmlFor='image'>
                    <Image className='mt-4' src={!image ? assets.upload_area : URL.createObjectURL(image)} width={140} height={70} alt='upload_area_icon' />
                </label>
                ...
                <textarea name='description' onChange={onChangeHandler} value={data.description} className='w-full sm:w-[500px] mt-4 px-4 py-3 border' rows={6} type='text' required placeholder='write content  here' />
